...
public class NxsecupTestContainer extends TestContainer {

    public NxsecupTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/nexbit/cuba/security/userprofile/app.properties",
    ...
    public static class Common extends NxsecupTestContainer {

        public static final NxsecupTestContainer.Common INSTANCE = new NxsecupTestContainer.Common();
